...
export const AppearanceMenu = () => {
  ...
  const [hoveredLayer, setHoveredLayer] = useState<keyof LayerVisibilityState | null>(null)
    ...
    >
      <button
        ...
        style={{
          ...
          backgroundColor:
            showSubmenu || appearanceHovered ? MENU_HOVER_BACKGROUND : "transparent",
        }}
          ...
          {LAYER_OPTIONS.map(({ key, label }) => {
            ...
            return (
              <button
                ...
                style={{
                  ...menuItemButton,
                  backgroundColor: isHovered ? MENU_HOVER_BACKGROUND : "transparent",
                }}
                onMouseEnter={() => setHoveredLayer(key)}
                onMouseLeave={() => setHoveredLayer((prev) => (prev === key ? null : prev))}
